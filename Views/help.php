...
<body>
    ...
    <section class="banner">
        ...
        <div class="rect8">
            <label class="text_block">Your Account May Have Been Blocked For One Of The Following Reasons<br>-Offensive Comment.<br>-Non Confirmed Email.<br>-Non Provided Plastic</label>
